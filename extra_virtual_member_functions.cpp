...
// the base class and is overridden by the derived class. When you refer
// to a derived class object using a pointer or a reference to the base
...
// The function resolution call is done at run-time.
